...
public class AuditableCollectionEntity {
    ...
    public static final String LAST_MODIFIED_DATE_COLUMN_NAME = "lastModifiedDate";

    @CreatedBy
    @Field(CREATED_BY_COLUMN_NAME)
    private String createdBy;

    @CreatedDate
    @Field(CREATED_DATE_COLUMN_NAME)
    private LocalDateTime createdDate;

    @LastModifiedBy
    @Field(LAST_MODIFIED_BY_COLUMN_NAME)
    private String lastModifiedBy;

    @LastModifiedDate
    @Field(LAST_MODIFIED_DATE_COLUMN_NAME)
